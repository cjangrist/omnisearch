...
**HTTP 524 from the upstream LLM gateway at ~130s is a hard ceiling.** The LLM gateway (`oauth-llm.example.invalid`) appears to enforce a ~130s deadline for kimi and gemini specifically.
